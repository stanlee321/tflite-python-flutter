...
class _DetectorServer {
  ...
  List<List<Object>?> _runInference(
    ...
    // final output = {
    //   // Assuming this tensor represents scores or classes and is correctly shaped as [1, 10]
    //   0: [List<num>.filled(10, 0)], // This might represent classes or scores, for example
    //   // Adjusting this tensor to have the correct shape [1, 10, 4], likely for bounding boxes
    //   1: [List<List<num>>.filled(10, List<num>.filled(4, 0))], // Corrected to [1, 10, 4]
    //   // Assuming the rest of the tensors are correctly shaped as [1, 10]
    //   2: [List<num>.filled(10, 0)], // This might represent scores or classes, for example
    //   // Assuming the number of detections is correctly shaped as [1]
    //   3: [0.0], // Number of detections
    // };

    // final output = {
    //   0: [List<List<num>>.filled(10, List<num>.filled(4, 0))], // Assuming bounding boxes: [1, 10, 4]
    //   1: [List<num>.filled(10, 0)], // Assuming class labels: [1, 10]
    //   2: [List<num>.filled(10, 0)], // Assuming scores: [1, 10]
    //   // Correcting the shape for the number of detections to [1]
    //   3: [0.0], // Corrected to represent the number of detections: [1]
    // };

// final output = {
//   0: [List<int>.filled(10, 0)], // If scores are expected to be double
//   1: [List.generate(10, (_) => List<int>.filled(4, 0))], // For bounding boxes, which are usually float values
//   2: [0], // If the number of detections is expected to be a single float value
//   3: [List<int>.filled(10, 0)], // If classes are expected to be double
// };
